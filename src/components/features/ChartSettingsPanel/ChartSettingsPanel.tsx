...
/**
 * Боковая панель настроек графика
 */
export function ChartSettingsPanel({ 
  ...
  useEffect(() => {
    ...
    // Добавляем с задержкой, чтобы не сработало сразу при открытии
...
export function ChartActionsMenu({ onExportSvg, onFullscreen, onGetEmbedCode }: ChartActionsMenuProps) {
  const { t } = useI18n();
